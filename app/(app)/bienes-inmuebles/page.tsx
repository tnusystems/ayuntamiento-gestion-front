// app/(app)/bienes-inmuebles/page.tsx
import BienesTable from "@/components/bienes/bienes-table";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Gestión integral de expedientes inmuebles y muebles del patrimonio
            municipal
          </p>
        </div>
      </div>
